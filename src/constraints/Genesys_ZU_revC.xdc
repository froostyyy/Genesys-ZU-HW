...
## Buttons
#set_property -dict { PACKAGE_PIN A12    IOSTANDARD LVCMOS18 } [get_ports { pl_buttons_tri_i[0] }]; #IO_L11P_AD9P_45/25 Sch=btnr
#set_property -dict { PACKAGE_PIN F12    IOSTANDARD LVCMOS18 } [get_ports { pl_buttons_tri_i[1] }]; #IO_L6P_HDGC_45/25 Sch=btnl
#set_property -dict { PACKAGE_PIN J12    IOSTANDARD LVCMOS18 } [get_ports { pl_buttons_tri_i[2] }]; #IO_L4P_AD12P_45/25 Sch=btnd
#set_property -dict { PACKAGE_PIN H12    IOSTANDARD LVCMOS18 } [get_ports { pl_buttons_tri_i[3] }]; #IO_L4N_AD12N_45/25 Sch=btnc
#set_property -dict { PACKAGE_PIN B10    IOSTANDARD LVCMOS18 } [get_ports { pl_buttons_tri_i[4] }]; #IO_L9N_AD11N_45/25 Sch=btnu
